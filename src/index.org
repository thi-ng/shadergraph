...
for Clojure/ClojureScript based OpenGL/WebGL projects and a dependency
graph / resolution mechanism for shader functions. A basic shader
minifier is included too (both compile-time and runtime versions are
provided).
...
partially refactored into pure functions.
...
Using another library like, e.g. [[https://github.com/thi-ng/geom/][thi.ng/geom]] 's WebGL module, these
shader sources can then be combined into a full shader like this (the
=make-shader-from-spec= function used below generates all attribute,
varying & uniform definitions and setters automatically):

#+BEGIN_SRC clojure
  (require '[thi.ng.geom.webgl.shaders :as shaders])
...
- [[buffers.org][thi.ng.glsl.buffers]]
- [[color.org][thi.ng.glsl.color]]
- [[distancefields.org][thi.ng.glsl.distancefields]]
- [[fog.org][thi.ng.glsl.fog]]
- [[grid.org][thi.ng.glsl.grid]]
- [[lighting.org][thi.ng.glsl.lighting]]
- [[matrix.org][thi.ng.glsl.matrix]]
- [[noise.org][thi.ng.glsl.noise]]
