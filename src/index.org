...
for ClojureScript based WebGL projects and a dependency graph /
resolution mechanism for these functions. A basic shader minifier is
included too (both compile-time and runtime versions are provided).
