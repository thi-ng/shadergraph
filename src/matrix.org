...
#+BEGIN_SRC glsl :noweb-ref invert
  mat2 invert(mat2 m) {
...
#+BEGIN_SRC glsl :noweb-ref transpose
...
#+BEGIN_SRC clojure :noweb yes :tangle ../babel/src/thi/ng/glsl/matrix.cljs :mkdirp yes :padline no
